---
title: 백엔드 프로세스 A to Z
slug: "/백엔드-프로세스-a-to-z"
date: 2023-04-02
---
...
Security Group    ,     Security Group    . RDS   MySQL     .
...
-  mock  unit test   
- integration test        
- state verification, behavior verification  mock, stub, fake  test double  
...
-      : PR merge CI Job   vs buildspec if  
...
-   API   : DB      . WAS security group   security group DB inbound  , zappa_settings.json security group   
- zappa certify  
- DDL   : SQLAlchemy     ,  DDL export    

###   Amazon SSM 

Amazon SSM Secrets Manager    .
...
- S3 upload,   CI 
- cloudfront 
- S3 bucket     restricting

###   3

- README.md  ,  ,  , black  badge 
...
Lambda     cold start    . alias      .

### DB read  replica 

master/slave primary/secondary   , read replication  .
...
### Repository Pattern DI 
   ...
   repository , Dependency Injection       . DAO, DTO, DO, marshal   .

### JWT  

identity    , blacklisting    , refresh       .

###   

- New Relic  SaaS APM  ,  CloudWatch  ElasticSearch , Elastic APM    .
- CloudWatch  , Elastic APM  , New Relic  , ELK Stack  , TICK Stack  .
-    Grafana       .
- StatsD        .
-       .
...
### Queue Worker
     ...
     worker  HTTP blocking    .

###   

front-end tier, back-end tier, data tier, monitoring tier      .
